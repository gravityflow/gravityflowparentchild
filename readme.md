Gravity Flow Parent-Child Forms Extension
==============================

Gravity Flow is a commercial plugin for WordPress which provides a Workflow platform for forms created in Gravity Forms.

Gravity Flow Parent-Child Extension is a commercial plugin for WordPress which allows Gravity Flow administrators to create parent-child relationships between forms.

This repository is a development version of the Gravity Flow Parent-Child Forms Extension and is intended to facilitate communication with developers. It is not stable and not intended for installation on production sites.
